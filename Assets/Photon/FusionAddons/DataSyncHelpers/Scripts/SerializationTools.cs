...
namespace Fusion.Addons.DataSyncHelpers
{
    public static class SerializationTools
    {
        ...
        #region Unserialisation from byte array to objects. unserializePosition is the offset position, in the original dataBytes array, where to extract the expected data from. unserializePosition will be offseted by the amount of read bytes
        // Unserialise a float from a byte array. unserializePosition is the offset position, in the original dataBytes array, where to extract the expected data from. unserializePosition will be offseted by the amount of read bytes
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        // Unserialise a int from a byte array. unserializePosition is the offset position, in the original dataBytes array, where to extract the expected data from. unserializePosition will be offseted by the amount of read bytes
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        // Unserialise a uint from a byte array. unserializePosition is the offset position, in the original dataBytes array, where to extract the expected data from. unserializePosition will be offseted by the amount of read bytes
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        // Unserialise a byte from a byte array. unserializePosition is the offset position, in the original dataBytes array, where to extract the expected data from. unserializePosition will be offseted by the amount of read bytes
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        // Unserialise a Vector3 from a byte array. unserializePosition is the offset position, in the original dataBytes array, where to extract the expected data from. unserializePosition will be offseted by the amount of read bytes
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        // Unserialise a Vector2 from a byte array. unserializePosition is the offset position, in the original dataBytes array, where to extract the expected data from. unserializePosition will be offseted by the amount of read bytes
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        // Unserialise a Quaternion from a byte array. unserializePosition is the offset position, in the original dataBytes array, where to extract the expected data from. unserializePosition will be offseted by the amount of read bytes
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        // Unserialise a NetworkBehaviourId from a byte array. unserializePosition is the offset position, in the original dataBytes array, where to extract the expected data from. unserializePosition will be offseted by the amount of read bytes
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
